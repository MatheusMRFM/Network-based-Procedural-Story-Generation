...
#define DELTA_GERAL					1
#define DELTA_CONFLITO 				7
#define DELTA_GUERRA 				7
#define DELTA_DISPUTA 				7
#define DELTA_ASSASSINATO			1
#define DELTA_DESCOBRE_ASSASSINO 	5
#define DELTA_REPRESSAO_POP		 	7
#define DELTA_CONFLITO_CIVIL	 	7
...
#define REDUZ_CONFLITO_FAC_POVO 	0.2
#define REDUZ_DECLARA_GUERRA 		0.4
#define REDUZ_DECLARA_GUERRA_POVO 	0.2
#define REDUZ_GUERRA			 	0.5
#define REDUZ_GUERRA_POVO 			0.3
#define REDUZ_DISPUTA_TERRITORIO	0.2
...
#define PROB_DECLARA_GUERRA 		0.2
#define PROB_GUERRA			 		0.2
#define PROB_TOMA_TERRITORIO		0.2
#define PROB_DISPUTA_TERRITORIO		0.023
#define PROB_DESCOBRE_ASSASSINO		0.05
#define PROB_REPRESSAO_POP			0.03
#define PROB_CONFLITO_CIVIL			0.03
#define PROB_CONFLITO_FACCAO		0.03
